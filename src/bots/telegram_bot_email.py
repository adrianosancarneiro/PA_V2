...
from email.integration import get_latest_emails, send_email
from email.providers.gmail_provider import GmailProvider
from email.providers.outlook_provider import OutlookGraphProvider
...
def get_available_providers():
    ...
    from email.integration import EmailProviderRegistry
