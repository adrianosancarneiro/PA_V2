...
CREDENTIALS_FILE = os.path.join(PROJECT_ROOT, "config", "client_secret_147697913284-lrl04fga24gpkk6ltv6ai3d4eps602lb.apps.googleusercontent.com.json")
TOKEN_FILE = os.path.join(PROJECT_ROOT, "config", "gmail_token.json")
