...
def load_provider_plugins(plugins_dir: str = None) -> None:
    """
    Load email provider plugins from the providers directory
    
    Args:
        plugins_dir (str): Directory containing provider plugins (optional)
    """
    if plugins_dir is None:
        # Default to the providers directory relative to this file
        plugins_dir = os.path.join(os.path.dirname(__file__), "providers")
